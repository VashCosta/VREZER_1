...
public class SecurityConfig {
    ...
    @org.springframework.beans.factory.annotation.Value("${app.cors.allowed-origins:https://vashcosta.github.io,https://vrezer-3-0.vercel.app,http://localhost:5173,http://localhost:3000,http://localhost:7000,http://localhost:9000,http://127.0.0.1:*}")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        if (originsList.isEmpty()) {
            originsList = List.of("https://vashcosta.github.io", "https://vrezer-3-0.vercel.app", "http://localhost:5173", "http://localhost:3000", "http://localhost:7000", "http://localhost:9000", "http://127.0.0.1:*");
        }
